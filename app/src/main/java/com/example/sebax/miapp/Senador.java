...
public class Senador extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.BTbosay:
                ...
                Intent intentkast = new Intent(Senador.this,Cores.class);
                Senador.this.startActivity(intentkast);
            ...
            case R.id.BTNsandra:
                ...
                Intent intentsandra = new Intent(Senador.this,Cores.class);
                Senador.this.startActivity(intentsandra);
                break;
            case R.id.BTNclaudio:
                ...
                Intent intentclaudio = new Intent(Senador.this,Core.class);
                Senador.this.startActivity(intentclaudio);
            ...
            case R.id.BTNrodrigo:
                ...
                Intent intentrodrigo = new Intent(Senador.this,Cores.class);
                Senador.this.startActivity(intentrodrigo);
            ...
            case R.id.BTveronica:
                ...
                Intent intentfoppiano = new Intent(Senador.this,Cores.class);
                Senador.this.startActivity(intentfoppiano);
                break;
            case R.id.BTNjoseMiguel:
                ...
                Intent intentjose = new Intent(Senador.this,Cores.class);
                Senador.this.startActivity(intentjose);
